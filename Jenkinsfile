        ...
        stage ('ZAP'){
            steps {
                ...
                script{
                    ...
                    sh '${DOCKER_EXEC} run --add-host="localhost:127.0.0.1" -v /var/jenkins_home/ZAP_2.10.0:/zap/wrk/:rw --rm -i owasp/zap2docker-stable zap-full-scan.py -t "http://demo.testfire.net/" -I -r zap_baseline_report2.html -l PASS'
                }
            }
        }
        stage('Scan Docker'){
